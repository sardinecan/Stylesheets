                                ...
                                <fileDesc>
                                    ...
                                    <sourceDesc>
                                        <msDesc>
                                            <msIdentifier>
                                                <repository>
                                                    <xsl:value-of select="current-group()[self::tei:p[@rend='lieuConservation']]"/>
                                                </repository>
                                                
                                            </msIdentifier>
                                        </msDesc>
                                        <xsl:if test="current-group()[self::tei:p[@rend='sourcesImprimees']]">
                                            <listBibl>
                                                <xsl:variable name="rgx" as="xs:string" expand-text="no">\[([^?\]]*)\]</xsl:variable>
                                                <xsl:analyze-string select="current-group()[self::tei:p[@rend='sourcesImprimees']]/normalize-space()" regex="{$rgx}">
